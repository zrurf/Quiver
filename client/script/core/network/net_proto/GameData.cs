...
public struct GameData : IFlatbufferObject
{
  ...
  public static Offset<net_proto.GameData> CreateGameData(FlatBufferBuilder builder,
      VectorOffset dataOffset = default(VectorOffset)) {
    builder.StartTable(1);
    GameData.AddData(builder, dataOffset);
    return GameData.EndGameData(builder);
  }

  public static void StartGameData(FlatBufferBuilder builder) { builder.StartTable(1); }
  ...
  public static Offset<net_proto.GameData> EndGameData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<net_proto.GameData>(o);
  }
}


static public class GameDataVerify
{

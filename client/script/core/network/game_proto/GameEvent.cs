...
public struct GameEvent : IFlatbufferObject
{
  ...
  public byte EventType { get { int o = __p.__offset(4); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  ...
  public static Offset<game_proto.GameEvent> CreateGameEvent(FlatBufferBuilder builder,
      byte event_type = 0,
  ...
  public static Offset<game_proto.GameEvent> EndGameEvent(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<game_proto.GameEvent>(o);
  }
}
...
static public class GameEventVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*EventType*/, 1 /*byte*/, 1, false)
